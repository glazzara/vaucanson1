...
//
#ifndef VCSN_DEMOS_UTILITIES_FSM_USUAL_AUTOMATON_T_ARG_HH
# define VCSN_DEMOS_UTILITIES_FSM_USUAL_AUTOMATON_T_ARG_HH
...
#endif // ! VCSN_DEMOS_UTILITIES_FSM_USUAL_AUTOMATON_T_ARG_HH
