...
//
#ifndef VCSN_TESTS_AUTOMATA_ALGOS_GRAPHS_TRIM_TEST_HH
# define VCSN_TESTS_AUTOMATA_ALGOS_GRAPHS_TRIM_TEST_HH

# include <vaucanson/algorithms/trim.hh>

template <class Auto>
bool	trim_test(tests::Tester& tg)
{
...
#endif // ! VCSN_TESTS_AUTOMATA_ALGOS_GRAPHS_TRIM_TEST_HH
