// krat_exp_partial_derivation_identity_test.hh: this file is part of the Vaucanson project.
//
...
//
#ifndef VCSN_TESTS_ALGEBRA_SERIES_KRAT_DERIVATIONS_PARTIAL_DERIVATION_KRAT_EXP_PARTIAL_DERIVATION_IDENTITY_TEST_HH
# define VCSN_TESTS_ALGEBRA_SERIES_KRAT_DERIVATIONS_PARTIAL_DERIVATION_KRAT_EXP_PARTIAL_DERIVATION_IDENTITY_TEST_HH
...
bool krat_exp_partial_derivation_identity_test(tests::Tester& tg)
{
  ...
  TEST_DERIVATE(tsts, sucs,
		identity_as<kexp_t>::of(series), a, std::set<Expr>());
  TEST_DERIVATE(tsts, sucs,
		identity_as<kexp_t>::of(series), b, std::set<Expr>());
...
#endif // ! VCSN_TESTS_ALGEBRA_SERIES_KRAT_DERIVATIONS_PARTIAL_DERIVATION_KRAT_EXP_PARTIAL_DERIVATION_IDENTITY_TEST_HH
