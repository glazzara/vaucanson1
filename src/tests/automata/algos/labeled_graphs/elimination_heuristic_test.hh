...
//
#ifndef VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_HEURISTIC_TEST_HH
# define VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_HEURISTIC_TEST_HH
...
#endif // ! VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_HEURISTIC_TEST_HH
