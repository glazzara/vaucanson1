...
//
#ifndef VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_DMHEURISTIC_TEST_HH
# define VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_DMHEURISTIC_TEST_HH
...
#endif // ! VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_DMHEURISTIC_TEST_HH
