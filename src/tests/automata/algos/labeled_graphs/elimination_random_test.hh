...
//
#ifndef VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_RANDOM_TEST_HH
# define VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_RANDOM_TEST_HH
...
bool elimination_random_test(tests::Tester& tg)
{
  ...
  for (unsigned nb = 0; nb < nb_test; ++nb)
      ...
      if (t.verbose() == tests::high)
	{
	  ...
	  SAVE_AUTOMATON_DOT("/tmp", "aut_to_exp_random", a, nb);
	}
      unsigned i = 0;
...
#endif // ! VCSN_TESTS_AUTOMATA_ALGOS_ELIMINATION_RANDOM_TEST_HH
