// is_isomorph_test.hh: this file is part of the Vaucanson project.
//
...
template <class Auto>
bool   is_isomorph_test(tests::Tester& tg)
{
  ...
  for (int i = 0; i < 100; ++i)
    {
      ...
      vcsn::is_isomorph(au1, au2);
    }
  return t.all_passed();
}

#endif // VCSN_TESTS_AUTOMATA_ALGOS_IS_ISOMORPH_TEST_HH
