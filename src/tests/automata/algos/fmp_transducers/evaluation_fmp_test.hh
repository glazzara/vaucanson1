...
#ifndef VCSN_TESTS_FMP_TRANSDUCERS_EVALUATION_FMP_TEST_HH
# define VCSN_TESTS_FMP_TRANSDUCERS_EVALUATION_FMP_TEST_HH
...
#endif // ! VCSN_TESTS_FMP_TRANSDUCERS_EVALUATION_FMP_TEST_HH
