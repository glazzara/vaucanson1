// minimization_aut_2n_openfst_bench.hh: this file is part of the Vaucanson project.
//
...
void minimization_aut_2n_openfst_bench(int n)
{
#ifndef OPENFST_PATH
  return;
#else
  ...
  BENCH_START("OpenFST minimization",
	      ...
	      "3* Run fstcompile on the input automaton (fork() + execl()).\n"
	      "4* Run fstminimize on the result (fork() + execl()).\n");
  ...
  name << "aut_2n_openfst/bench_minimization_aut_2n_openfst_" << n;
