// determinization_aut_ladybird_openfst_bench.hh: this file is part of the Vaucanson project.
//
...
void determinization_aut_ladybird_openfst_bench(int n)
{
#ifndef OPENFST_PATH
  return;
#else
  ...
  automaton_t a = aut_ladybird(n);

  std::string fsmname = "aut_ladybird_openfst/aut_ladybird.fsm";
  std::string fstin = "aut_ladybird_openfst/in.fst";
  std::string fstout = "aut_ladybird_openfst/out.fst";
  ...
  BENCH_START("OpenFST determinization",
	      ...
	      "\n"
	      "Input is the ladybird automaton\n"
  ...
  name << "aut_ladybird_openfst/bench_determinization_aut_ladybird_openfst_"
       << n;
