// min_plus.hh: this file is part of the Vaucanson project.
//
...
#ifndef VCSN_XML_CONTEXTS_MIN_PLUS_HH
# define VCSN_XML_CONTEXTS_MIN_PLUS_HH
...
namespace vcsn
{
  namespace xml
  {
	...
	vcsn::algebra::TropicalSemiring<vcsn::algebra::TropicalMin>
      >(const vcsn::algebra::TropicalSemiring<vcsn::algebra::TropicalMin>&);
    } // !builders
  } // !xml
} // !vcsn

# if !defined VCSN_USE_INTERFACE_ONLY || defined VCSN_USE_LIB
#  include <vaucanson/xml/contexts/min_plus.hxx>
# endif // VCSN_USE_INTERFACE_ONLY || !VCSN_USE_LIB

#endif // !VCSN_XML_CONTEXTS_MIN_PLUS_HH
