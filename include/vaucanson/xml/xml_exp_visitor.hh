...
#ifndef VCSN_XML_XML_EXP_VISITOR_HH
# define VCSN_XML_XML_EXP_VISITOR_HH
...
namespace vcsn {
  ...
  namespace rat {
    ...
    protected:
      ...
      template <typename T>
      void set_weight(const T& w, xercesc::DOMElement* node);
      template <typename S, typename T>
      void set_weight(const rat::exp<S, T>& w, xercesc::DOMElement* node);
...
#  include <vaucanson/xml/xml_exp_visitor.hxx>
# endif // VCSN_USE_INTERFACE_ONLY

#endif // ! VCSN_XML_XML_EXP_VISITOR_HH
