...
namespace vcsn {
  ...
  namespace tools {
    ...
    typedef polynom<WordValue, bool>	usual_series_set_elt_value_t;
    typedef polynom<WordValue, int>	weighted_series_set_elt_value_t;
    ...
    <
      ...
      WordValue,
      int,
      weighted_series_set_elt_value_t,
      char,
      NoTag>
