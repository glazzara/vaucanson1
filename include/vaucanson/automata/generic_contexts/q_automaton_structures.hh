// q_automaton_structures.hh: this file is part of the Vaucanson project.
//
...
# define VCSN_CONTEXT_NAMESPACE namespace q_automaton
...
# include <vaucanson/contexts/q_semiring.thh>
