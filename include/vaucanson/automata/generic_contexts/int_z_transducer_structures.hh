// int_z_transducer_structures.hh: this file is part of the Vaucanson project.
//
...
# include GRAPH_CONTEXT_HEADER_(int_z_automaton_structures.hh)
# include GRAPH_CONTEXT_HEADER_(int_boolean_automaton_structures.hh)

# define AUTOMATON_CONTEXT int_z_automaton
# define VCSN_CONTEXT_NAMESPACE namespace int_z_transducer
