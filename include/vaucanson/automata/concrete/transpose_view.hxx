...
#ifndef VCSN_AUTOMATA_CONCEPT_TRANSPOSE_VIEW_HXX
# define VCSN_AUTOMATA_CONCEPT_TRANSPOSE_VIEW_HXX
...
#define AutoType(Type) \
  ...
  op_add_serie_edge(const AutomataBase<S>& s, 
		    ...
		    hstate_t from, 
		    hstate_t to, 
		    const typename Element<S, T>::serie_t& se)
  {
...
#endif // VCSN_AUTOMATA_CONCEPT_TRANSPOSE_VIEW_HXX
