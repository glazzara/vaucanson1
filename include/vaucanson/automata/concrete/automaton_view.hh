...
#ifndef VCSN_AUTOMATA_CONCEPT_AUTOMATON_VIEW_HH
# define VCSN_AUTOMATA_CONCEPT_AUTOMATON_VIEW_HH
...
#define AutoType(Type) \
  ...
  op_serie_value_of(const AutomataBase<S>&, const IdentityView<T>&,
		    hedge_t);
...
#endif // VCSN_AUTOMATA_CONCEPT_AUTOMATON_VIEW_HH
