...
/**
 * @file   bitset.hxx
 * @brief  Bitset class implementaion.
 *
...
namespace std
{
  ...
  insert_iterator (vcsn::misc::Bitset& x,
		   vcsn::misc::Bitset::iterator)
  {
    container = &x;
  }
  ...
  inline
  insert_iterator<vcsn::misc::Bitset>&
  insert_iterator<vcsn::misc::Bitset>::operator= (vcsn::misc::Bitset::
  ...
  inline
  insert_iterator<vcsn::misc::Bitset>&
  insert_iterator<vcsn::misc::Bitset>::operator* ()
  {
    return *this;
  }
  ...
  inline
  insert_iterator<vcsn::misc::Bitset>&
  insert_iterator<vcsn::misc::Bitset>::operator++ (int)
  {
    return *this;
  }
}

#endif // ! VCSN_MISC_BITSET_HXX
