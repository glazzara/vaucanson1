...
# define AUTOMATON_TYPES_MAYBE_TYPENAME(AutoType, Prefix, Typename)	\
  ...
  typedef Typename AutoType::delta_transition_t			Prefix##delta_transition_t; \
  typedef Typename AutoType::delta_state_t			Prefix##delta_state_t; \
  typedef Typename AutoType::const_delta_transition_t		Prefix##const_delta_transition_t; \
  typedef Typename AutoType::const_delta_state_t		Prefix##const_delta_state_t;
