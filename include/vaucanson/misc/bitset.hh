...
namespace std
{
  ...
  {
    public:
      typedef vcsn::misc::Bitset container_type;

      insert_iterator (vcsn::misc::Bitset& x, vcsn::misc::Bitset::iterator);
      insert_iterator<vcsn::misc::Bitset>&
      operator= (vcsn::misc::Bitset::const_reference value);
      insert_iterator<vcsn::misc::Bitset>& operator* ();
      insert_iterator<vcsn::misc::Bitset>& operator++ ();
      insert_iterator<vcsn::misc::Bitset>& operator++ (int);
    protected:
      vcsn::misc::Bitset* container;
  };
}
