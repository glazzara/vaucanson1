...
There is a specificity about the \xattr{label} attribute of the
\xtag{transition} tag. Most of the time, there isn't any problem since
...
The \xattr{in} and \xattr{out} attributes follow the same rules for
transducers.

These attributes are just introduced to help the user in a first time. We
strongly recommend the use of the element for label definitions.
