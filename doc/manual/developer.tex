...
to do it too.  In the following list, \samp{*} stands for ``nothing,
or a number''.
\begin{description}
\item[al*, alpha*, A*] alphabets
\item[a*, aut*] automata (\code{automaton_t}, etc.)
\item[t*, tr*] transitions
\item[p*, q*, r*, s*] states (\code{hstate_t})
\end{description}
