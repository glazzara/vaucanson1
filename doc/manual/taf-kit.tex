...
\execcaption{a1dmi}{vcsn-char-b identity-nodep a1.xml | vcsn-char-b determinize - | vcsn-char-b minimize - | vcsn-char-b info -}
...
\execcaption{bz-mismatch}{vcsn-char-b identity-nodep a1.xml | vcsn-char-b info -}
...
\execcaption{a1-dump}{vcsn-char-b identity-nodep a1.xml}
...
\execcaption{a1-xml}{vcsn-char-b identity-nodep a1.xml >my-a1.xml}
...
\execcaption{a1-dot}{vcsn-char-b --output-type=dot identity-nodep a1.xml >a1.dot}
\begin{center}
...
\execcaption{a1det}{vcsn-char-b identity-nodep a1.xml | vcsn-char-b determinize - >a1det.xml}
...
\execcaption{a1det.dot}{vcsn-char-b --output-type=dot identity a1det.xml >a1det.dot}
\begin{center}
...
\execcaption{a1.abab}{vcsn-char-b eval-nodep a1.xml 'abab'}
\execcaption{a1.bbba}{vcsn-char-b eval-nodep a1.xml 'bbba'}
...
\execcaption{all.dot}{vcsn-char-b --output-type=dot identity all.xml >all.dot}
\begin{center}
...
\execcaption{parser.dot}{vcsn-char-b --output-type=dot identity parser.xml >parser.dot}
\begin{center}
...
\execcaption{parser2.dot}{vcsn-char-b --output-type=dot identity parser2.xml >parser2.dot}
\begin{center}
...
\execcaption{allmin.dot}{vcsn-char-b --output-type=dot identity allmin.xml >allmin.dot}
\begin{center}
...
\execcaption{l1.dot}{vcsn-char-b --output-type=dot identity l1.xml >l1.dot}
\begin{center}
...
\execcaption{t1.dom}{vcsn-char-fmp-b identity-nodep t1.xml | vcsn-char-fmp-b --alphabet1=ab domain - >div-by-3.xml}
...
\execcaption{div-by-3.dot}{vcsn-char-b --output-type=dot identity div-by-3.xml >div-by-3.dot}
...
\execcaption{b1.abbb}{vcsn-char-z identity-nodep b1.xml | vcsn-char-z eval - 'abbb'}
\execcaption{b1.abab}{vcsn-char-z identity-nodep b1.xml | vcsn-char-z eval - 'abab'}
...
\execcaption{b4}{vcsn-char-z identity-nodep b1.xml | vcsn-char-z power - 4 >b4.xml}
\begin{shell}
...
\execcaption{b1.info}{vcsn-char-z identity-nodep b1.xml | vcsn-char-z info -}
