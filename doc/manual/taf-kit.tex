...
\begin{shell}
# \kbd{vcsn-b --alphabet=ab define-automaton all.xml}
...
\execcaption{all.xml}{vcsn-b --alphabet=ab exp-to-aut '(a+b)*' >all.xml}
\execcaption{all.dot}{vcsn-b dot-dump all.xml >all.dot}
\begin{center}
...
\execcaption{allmin.xml}{vcsn-b minimize all.xml >allmin.xml}
\execcaption{allmin.dot}{vcsn-b dot-dump allmin.xml >allmin.dot}
\begin{center}
...
\execcaption{all.rat}{vcsn-b aut-to-exp all.xml}
\execcaption{allmin.rat}{vcsn-b aut-to-exp allmin.xml}
...
\execcaption{l1}{vcsn-b --alphabet=ab standard "(a+b)*a.b.(a+b)*" | vcsn-b quotient - >l1.xml}
