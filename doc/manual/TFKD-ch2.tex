...
\longonly{%
\begin{ComVd}{110725}
Cette liste est complŽtŽe celle des commandes qui n'ont finalement 
pas ŽtŽ implŽmentŽes dans \tafkitv, ou qui ont ŽtŽ implŽmentŽes pour 
une classe plus restreinte d'automates, mais dont on garde la trace 
pour les versions ˆ venir.
\end{ComVd}
}%
