...
\textbf{Caveat:} because \Vauc builds rational expressions on the of
...
the case.  For instance \samp{ab*} is the same rational expression as
\samp{(ab)*}, but it is different from \samp{a.b*} or \samp{a.(b*)}.
